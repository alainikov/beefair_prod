...
$contactForm .= 		'<div class="col-xs-10 col-md-5 col-lg-4">';
$contactForm .= 			'<input class="inputBig form-control" type="text" id="txtContactName" maxlength="180" size="30">';
$contactForm .= 		'</div>';
$contactForm .= 	'</div>';
$contactForm .= 	'<div class="form-group">';
$contactForm .= 		'<label class="control-label col-xs-3 col-md-5 col-lg-5" for="email">E-Mail *</label>';
$contactForm .= 		'<div class="col-xs-10 col-md-5 col-lg-4">';
$contactForm .= 			'<input class="inputBig form-control" type="email" id="txtContactEmail" maxlength="255" size="30">';
$contactForm .= 		'</div>';
$contactForm .= 	'</div>';
$contactForm .= 	'<div class="form-group">';
$contactForm .= 		'<label class="control-label col-xs-3 col-md-5 col-lg-5" for="telephone">Telefon</label>';
$contactForm .= 		'<div class="col-xs-10 col-md-5 col-lg-4">';
