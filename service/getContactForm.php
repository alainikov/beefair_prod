...
$contactForm .= 		'<label class="control-label col-xs-5 col-md-4 col-lg-5" for="name">Name/Firma *</label>';
...
$contactForm .= 	'</div>';
$contactForm .= 	'<div class="form-group">';
$contactForm .= 		'<label class="control-label col-xs-5 col-md-4 col-lg-5" for="email">E-Mail *</label>';
...
$contactForm .= 	'</div>';
$contactForm .= 	'<div class="form-group">';
$contactForm .= 		'<label class="control-label col-xs-5 col-md-4 col-lg-5" for="telephone">Telefon</label>';
$contactForm .= 		'<div class="col-xs-8 col-md-5 col-lg-4">';
