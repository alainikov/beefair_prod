...
$contactForm .= 		'<label class="control-label col-xs-6 col-md-4 col-lg-5" for="name">Name/Firma *</label>';
$contactForm .= 		'<div class="col-xs-12 col-md-8 col-lg-4">';
$contactForm .= 			'<input class="inputBig form-control" type="text" id="txtContactName" maxlength="180" size="30">';
$contactForm .= 		'</div>';
$contactForm .= 	'</div>';
$contactForm .= 	'<div class="form-group">';
$contactForm .= 		'<label class="control-label col-xs-4 col-md-4 col-lg-5" for="email">E-Mail *</label>';
$contactForm .= 		'<div class="col-xs-9 col-md-5 col-lg-4">';
$contactForm .= 			'<input class="inputBig form-control" type="email" id="txtContactEmail" maxlength="255" size="30">';
$contactForm .= 		'</div>';
$contactForm .= 	'</div>';
$contactForm .= 	'<div class="form-group">';
$contactForm .= 		'<label class="control-label col-xs-4 col-md-4 col-lg-5" for="telephone">Telefon</label>';
$contactForm .= 		'<div class="col-xs-9 col-md-5 col-lg-4">';
$contactForm .= 			'<input class="inputBig form-control" type="text" id="txtContactPhone" maxlength="40" size="30">';
$contactForm .= 		'</div>';
$contactForm .= 	'</div>';
$contactForm .= 	'<div class="form-group">';
$contactForm .= 		'<label class="control-label col-xs-5 col-md-4 col-lg-5" for="comments">Mitteilung *</label>';
$contactForm .= 		'<div class="col-xs-8 col-md-5 col-lg-4">';
$contactForm .= 			'<textarea class="textareaBig form-control" id="txtContactComments" maxlength="1000" cols="25" rows="6"></textarea>';
$contactForm .= 		'</div>';
$contactForm .= 	'</div>';
$contactForm .= 	'<div class="form-group">';
$contactForm .= 		'<div class="col-lg-12 col-md-12 col-xs-12">';
